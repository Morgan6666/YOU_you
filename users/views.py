...
def profile_view(request, slug):
    p = Profile.objects.flter(slug = slug).first()
    u = p.user
    ...
    context = {
        ...
        'rect_friend_requests': rec_friend_requests,
...
def edit_profile(request):
    if request.method == 'POST':
        u_form = UserUpdateForm(request.POST, isinstance = request.user)
